...
class UploadActivity : AppCompatActivity() {
    ...
    fun uploadClicked(view: View) {
        ...
        val reffrence = storage.reference
        val imagesReffrence = reffrence.child("images").child(imageName)
        if (selectedPicture != null) {
            imagesReffrence.putFile(selectedPicture!!).addOnSuccessListener { taskSnapshot ->
